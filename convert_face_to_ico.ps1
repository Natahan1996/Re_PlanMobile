...
$sourcePath = "C:\Users\Natha\.gemini\antigravity\scratch\scheduler_app\mascot_face.png"
$destPath = "C:\Users\Natha\.gemini\antigravity\scratch\scheduler_app\app_face_transparent.ico"
...
try {
    ...
    Write-Host "Successfully created app_face_transparent.ico"
} catch {
